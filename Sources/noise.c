...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/30 12:01:41 by mmoullec          #+#    #+#             */
/*   Updated: 2017/01/30 16:50:19 by mmoullec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double			noise(double x, double y, double z)
{
	...
	perlin(noise.per);
	fill_xyz(&noise, x, y, z);
	x -= floor(x);
	y -= floor(y);
	z -= floor(z);
	fill_uvw(&noise, x, y, z);
	fill_baba(&noise);
	return (noise_to_ret(&noise, x, y, z));
}
